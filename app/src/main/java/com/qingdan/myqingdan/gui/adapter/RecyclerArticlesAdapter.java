...
public class RecyclerArticlesAdapter extends RecyclerBaseAdapter<ResponseMainListData.DataBean.ArticlesBean> {



    public RecyclerArticlesAdapter(Context context) {
        super(context);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (position < getHeaderCount()) {
            ...
            mHolder.textViewFrontSubtitle.setText(nodesBean.getExcerpt());
